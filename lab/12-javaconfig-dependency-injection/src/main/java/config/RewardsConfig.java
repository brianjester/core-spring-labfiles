 ...
 *
 * xTODO-01: Make this class a Spring configuration class
 * - Use an appropriate annotation.
 *
 * xTODO-02: Define four empty @Bean methods, one for the
 ...
 *   - rewardRepository
 *
 * xTODO-03: Inject DataSource through constructor injection
 ...
 *
 * xTODO-04: Implement each @Bean method to contain the code
...
public class RewardsConfig {
	...
	@Bean
	public RewardNetwork rewardNetwork() {return new RewardNetworkImpl(this.accountRepository(), this.restaurantRepository(), this.rewardRepository());}

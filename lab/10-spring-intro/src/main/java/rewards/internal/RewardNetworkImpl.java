 ...
 *
 * xTODO-01: Review the Rewards Application document (Refer to the lab document)
 * xTODO-02: Review project dependencies (Refer to the lab document)
 * xTODO-03: Review Rewards Commons project (Refer to the lab document)
 * xTODO-04: Review RewardNetwork interface and RewardNetworkImpl class below
 * xTODO-05: Review the RewardNetworkImpl configuration logic (Refer to the lab document)
 * xTODO-06: Review sequence diagram (Refer to the lab document)
 */
public class RewardNetworkImpl implements RewardNetwork {
	...
	public RewardConfirmation rewardAccountFor(Dining dining) {
		// xTODO-07: Write code here for rewarding an account according to
		//          the sequence diagram in the lab document
		Account account = accountRepository.findByCreditCard(dining.getCreditCardNumber());
		Restaurant restaurant = restaurantRepository.findByMerchantNumber(dining.getMerchantNumber());
		MonetaryAmount benefitAmount = restaurant.calculateBenefitFor(account, dining);
		AccountContribution contribution = account.makeContribution(benefitAmount);
		accountRepository.updateBeneficiaries(account);
		// xTODO-08: Return the corresponding reward confirmation

...
// xTODO-01: Make this class a Spring Boot test class
// - Add @SpringBootTest annotation with WebEnvironment.RANDOM_PORT
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class AccountClientTests {

	// xTODO-02: Autowire TestRestTemplate bean to a field
	// - Name the field as restTemplate
	@Autowired
	private TestRestTemplate restTemplate;

	// xTODO-03: Update code below to use TestRestTemplate (as opposed to RestTemplate)
...
//	private RestTemplate restTemplate = new RestTemplate();
	...
	// xTODO-04: Modify the code below so that it handles 404 HTTP response status
	...
	// xTODO-05: Observe a log message in the console indicating

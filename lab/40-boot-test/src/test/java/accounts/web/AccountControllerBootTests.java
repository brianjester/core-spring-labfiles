...
// xTODO-06: Get yourself familiarized with various testing utility classes
...
// xTODO-07: Replace @ExtendWith(SpringExtension.class) with the following annotation
// - @WebMvcTest(AccountController.class) // includes @ExtendWith(SpringExtension.class)
@WebMvcTest(AccountController.class)
public class AccountControllerBootTests {

	// xTODO-08: Autowire MockMvc bean
	@Autowired
	private MockMvc mockMvc;

	// xTODO-09: Create AccountManager mock bean using @MockBean annotation
	@MockBean
	private AccountManager accountManager;

	// xTODO-10: Write positive test for GET request for an account
	...
	// xTODO-11: Write negative test for GET request for a non-existent account
    ...
    // xTODO-12: Write test for `POST` request for an account

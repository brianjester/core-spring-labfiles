 ...
 *
 */
// xTODO-03: Add an appropriate annotation to make this class a REST controller
@RestController
public class AccountController {
	 ...
	 */
	// xTODO-04: Add an appropriate annotation to make this method handle "/accounts"
	@GetMapping("/accounts")
	public List<Account> accountList() {

		// xTODO-05: Implement the logic to find and return all accounts
...
//		return null; // REPLACE THIS LINE to return a list accounts
		...
		// xTODO-06: (If you are using STS) We are about to make lots of
		//          changes, so stop the application otherwise Devtools
		//          will keep restarting it.
	}

	// xTODO-08: Implement the /accounts/{entityId} request handling method.
	...
	// xTODO-10b: If AccountControllerTests.testHandleDetailsRequest()
	//  fails, fix errors before moving on

	// xTODO-11: Run the application

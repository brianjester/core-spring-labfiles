...
// xTODO-10: Enable method security
...
public class RestSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((authz) -> authz
                ...
                // xTODO-04: Configure authorization using requestMatchers method
	...
	// xTODO-14b (Optional): Remove the InMemoryUserDetailsManager definition
	// - Comment the @Bean annotation below
	
	//@Bean
    public InMemoryUserDetailsManager userDetailsService(PasswordEncoder passwordEncoder) {

		// xTODO-05: Add three users with corresponding roles:

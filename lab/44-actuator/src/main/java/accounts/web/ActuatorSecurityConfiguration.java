...
// xTODO-21: Add Spring Boot security starter to the pom.xml or build.gradle
// - You might want to refresh the IDE so that it picks up the change in the build file
//
// xTODO-22: Uncomment code below until there is no compile error
...
public class ActuatorSecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        // xTODO-23: Configure access control to actuator endpoints as following
